...
function CssSizeEditorView(cssSizeEditorModel) {
  ...
  this.sliderDom.focusin(function() {
    $this.cssSizeEditorModel.setAsFocussedModel();
  });
  ...
  this.cssSizeEditorModel.shortDescription.nowAndOnChange(function(shortdescription) {
    $this.shortDescriptionDom.toggle(shortdescription != null);
  ...
  $(this.cssSizeEditorModel).on("modelFocus", function() {
    $this.focusOnSlider();
  });
  
}

CssSizeEditorView.prototype = {
