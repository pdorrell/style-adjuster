...
FormatsStateModel.prototype = {
  setFormatsController: function(formatsController) {
...
function FormatsView(formatsStateModel) {
  ...
  var $this = this;
  this.formatsStateModel.nowAndOnUpdate(function (formats) {
    $this.dom.toggle(formats != null);
    if (formats != null) {
      $this.setOptions(formatsModel.formats);
    }
  });
  this.formatsStateModel.selectedFormat.nowAndOnUpdate(function(selectedFormat) {
    $this.dom.find("option").each(function() {
      this.selected = (this.value == selectedFormat);
    });
  });
  this.formatsStateModel.formatsEnabled.nowAndOnUpdate(function(formatsEnabled) {
    $this.dom.find("option").each(function() {
