...
function ValueEditorModel() {
  ...
  this.extraValueEditorModel = new Observable(null);
}
...
ValueEditorModel.prototype = {
  ...
  setExtraValueEditorModelFor: function(propertyModel) {
    ...
    this.extraValueEditorModel.set(extraValueEditorModel);
  },
  ...
  updateFromPropertyModel: function(fromExtraModelEditor) {
    ...
    if(!fromExtraModelEditor) {
      var extraValueEditorModel = this.extraValueEditorModel.get();
      if (extraValueEditorModel != null) {
        extraValueEditorModel.setValueString(value);
      }
    }
  }
...
function ValueEditorView(valueEditorModel) {
  ...
  this.extraValueEditorView = null;
  var $this = this;
  ...
  this.valueEditorModel.extraValueEditorModel.nowAndOnChange(function(extraValueEditorModel) {
    $this.extraEditorDom.children().detach();
    var extraValueEditorView = extraValueEditorModel == null ? null : extraValueEditorModel.view;
    if (extraValueEditorView == null) {
      $this.extraEditorDom.hide();
    }
    else {
      $this.extraEditorDom.append(extraValueEditorView.dom);
...
CssSizeEditorModel.prototype = {
  ...
  updateValue: function(value) {
    ...
    this.parentEditor.saveValue(value, true);
  }, 
