...
function StyleAdjusterView(parentDom, styleAdjusterModel) {
  ...
  this.styleAdjusterModel = styleAdjusterModel;
  this.dom = $("<div class = 'style-adjuster' title='Style Adjuster'/>");
  this.tabsDom = $("<div/>").appendTo(this.dom);
...
function StyleSheetRulesView(styleSheetModel) {
  ...
  hrefSpan("<h2/>", styleSheetModel.styleSheet.href).appendTo(this.dom);
...
function EditView(styleAdjusterModel) {
  ...
  this.emptyMessageDom = $("<div class='empty-message'>").text("(No rules have been selected)").hide();
  this.dom.append(this.emptyMessageDom);
