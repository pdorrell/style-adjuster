...
ColorFormatsController.prototype = {
  ...
  valueChanged: function(value) {
    var parsedColor = this.colorParser.parse(value);
    console.log("ColorFormatsController.valueChanged " + inspect(value) + ", parsedColor = " + parsedColor);
    var valueFormat = parsedColor == null ? null : parsedColor.format;
    this.formatsStateModel.selectedFormat.set(valueFormat);
    var formatsEnabled = {};
    if (valueFormat != null) { // null means not valid (shouldn't happen ??)
      var formats = parsedColor.enabledFormats();
