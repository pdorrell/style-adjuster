...
function ColorFormatsModel() {
  this.formats = ["name", "rgb", "rgba", "hsl", "hsla", "hex"];
}

ColorFormatsModel.prototype = {
  getStateForValue: function(value) {
...
function CssType(editorModel, denormaliser, formatsModel, description) {
