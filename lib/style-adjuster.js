  ...
  setPropertyValue: function(name, value) {
    ...
    for (var i=0; i<this.properties.length; i++) {
      if (this.properties[i].name == name) {
        this.properties[i].value.set(newCssPropertyModels[i].value);
      }
    }
  }, 
...
PropertyModel.prototype = {
  ...
  updateValue: function(value) {
    this.ruleModel.setPropertyValue(this.name, value);
    this.value.set(value);
    this.changed.set(value != this.originalValue);
  }, 
...
TextValueEditor.prototype = {
  ...
  editProperty: function(propertyModel) {
    ...
    this.valueField.val(this.propertyModel.value.get());
