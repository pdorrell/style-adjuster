...
function FormatsStateModel() {
  ...
  this.selectedFormat.log = true;
  this.selectedFormat.description = "FormatsStateModel.selectedFormat";
...
FormatsStateModel.prototype = {
  ...
  setFormatsController: function(formatsController, initialValue) {
    ...
    if (formatsController == null) {
      ...
      this.formats.set(formatsController.formats);
...
function CssSizeType(allowNegative) {
  ...
  this.description = "CSS size (" + (allowNegative ? "positive or negative" : "non-negative only") + ")";
...
function FourCssSizesType(allowNegative) {
  this.allowNegative = allowNegative;
  this.description = "CSS sizes for top/left/bottom/right (" + 
...
var propertyTypes = 
  {"margin": new FourCssSizesType(true), 
   "padding": new FourCssSizesType(false),
   "border-width": new FourCssSizesType(false), 
   "font-size": new CssSizeType(false), 
   "width": new CssSizeType(false), 
   "min-width": new CssSizeType(false), 
   "max-width": new CssSizeType(false), 
   "color": colorType(), 
   "background-color": colorType()
  };

addTopLeftBottomRightTypes(propertyTypes, "padding-", "", new CssSizeType(false));
addTopLeftBottomRightTypes(propertyTypes, "margin-", "", new CssSizeType(true));
