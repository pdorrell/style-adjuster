...
PropertyModel.prototype = {
  ...
  updateValueViaFormatsController: function(value, formatsController) {
    ...
    if (parsedValue == null) {
      console.log("formatsController parse error");
...
ColorFormatsController.prototype = {
  ...
  resetUpdatedValue: function(updatedValueString, parsedInputValue) {
    ...
    if (parsedUpdatedValue == null) {
      ...
      console.log("parsedUpdatedValue = " + parsedUpdatedValue);
      ...
      if (parsedUpdatedValue.format != parsedInputValue.format) {
        ...
        console.log(" parsedInputValue.format = " + inspect(parsedInputValue.format));
        console.log(" enabledFormats = " + inspect(enabledFormats));
        if ($.inArray(parsedInputValue.format, enabledFormats) != -1) {
