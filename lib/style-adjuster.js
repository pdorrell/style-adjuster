  ...
  resetUpdatedValue: function(updatedValueString, parsedInputValue) {
    ...
    if (parsedUpdatedValue == null) {
      ...
      if (parsedUpdatedValue.format != parsedInputValue.format) {
        console.log("parsedUpdatedValue (of different formula) = " + parsedUpdatedValue);
        ...
        console.log(" reconstructibleFormats = " + inspect(reconstructibleFormats));
        if ($.inArray(parsedInputValue.format, reconstructibleFormats) != -1) {
          ...
          if (testNewValue) {
            ...
            //console.log("Test (maybe inexact) reconstruction = " + testNewValue);
            //console.log("");
          }
